  ...
  return (
    <section className="relative z-10 drawer">
      ...
      <section className="drawer-side min-h-full">
        ...
        {/* Drawer Content */}
        <section className="bg-base-200 p-4 lg:w-80 min-h-full flex flex-col">
          {/* Sticky Toggle Button Positioned on Drawer Side */}
          <div className="fixed -right-16 top-20 z-20">
