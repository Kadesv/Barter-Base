...
export default function SignInForm({ onCancel, handleSignIn }) {
    ...
    return (
        <section>
                ...
                <form class="justify-center items-center h-screen max-w-sm mx-auto md:max-w-sm gap-3 items-center text-center" onSubmit={(e) => {
                    handleSignIn(e, {
                        email: emailValue,
                    ...
                    {/* email */}
                    <label class="input input-bordered flex items-center gap-2 md:shrink-0 my-4">
