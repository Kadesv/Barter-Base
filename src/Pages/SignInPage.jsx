            ...
            <>
                ...
                >
                    ...
                    <div className="flex w-full flex-col">
                        <button
                            className="btn border-base-300 m-1 border-2 hover:border-base-200 hover:bg-base-100 bg-base-200 rounded-lg grid h-10 place-items-center"
                            type="submit"
                        >
                            Log In
                        </button>
                        ...
                        <a
                            className="btn border-base-300 m-1 border-2 hover:bg-base-100 hover:border-base-200 bg-base-200 rounded-lg grid h-10 place-items-center"
                            href="/signUp"
                        >
                            Create Account
                        </a>
