        ...
        <div className="justify-center items-center h-screen my-20 max-w-sm mx-auto md:max-w-sm gap-3 text-center">
            <>
                <form onSubmit={(e) => {
                    ...
                    {/* email */}
                    <label className="input bg-base-100 focus-within:opacity-100 focus-within:bg-base-300 opacity-95 flex items-center gap-2 md:shrink-0 my-4">
                    ...
                    <div className="flex w-full flex-col">
                        <button className="btn opacity-95 hover:opacity-100 bg-base-100 rounded-lg grid h-10 place-items-center" type="submit">Log In</button>
                        <div className=" divider opacity-95 text-base-100 before:bg-base-100 after:bg-base-100">or</div>
                        <button className="btn opacity-95 hover:opacity-100 bg-base-100 rounded-lg grid h-10 place-items-center" onClick={handleCreate}>Create Account</button>
                    </div>
                </form>
            </>
        </div>
